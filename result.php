...
$result4= mysql_query("SELECT * FROM result_publish where short_name='$exam' && batch='$batch'"); //Declare result

while($row= mysql_fetch_array($result4))
  {
  $status= $row['status'];
  $notpublish= $row['message'];
  }
...
if('1st'==$exam){
    ...
    $p=' 1st Paper';
      ...
      $ok='1';
        ...
        $message='<center><table  bordercolor="black" width="auto" height="87" style="background-color:#0cc; text-align:center;"><tr><td style="font-size:24px"><b>&nbsp;&nbsp;&nbsp;'.$notpublish.'&nbsp;&nbsp;&nbsp;</b></td></tr></table><br /><br /></h3></center>';
    $ok='0';
    }
                ...
                <!-- /.row -->
                     ...
                     <table class="table table-bordered table-hover table-striped">
                              ...
                              <?php  if('1'==$ok){
                                ...
                                ?><button align='right' class="btn btn-default"  onclick="JavaScript:window.print();" >Print Result</button><br /><br />
