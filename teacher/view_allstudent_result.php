...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Showing Result of <?php echo $exam1;?> Of Batch: <?php echo $batch; echo ' ('.$department .$paper.')';?></strong>
                        </h4>

          <a href="allstudent_result.php"><button type="button" class="btn btn-xs btn-default">Back</button></a><br /><br />
  <center>
  <table align="center"  class="table table-striped table-bordered table-hover">
    <tr ><td  width="16%" bgcolor="#cccccc">&nbsp;<strong> Roll no</strong></td>
      ...
      <td   width="auto"  bgcolor="#cccccc" ><strong>Group</strong></td>
       <td    bgcolor="#cccccc" width="auto"><strong><center>Marks</center></strong></td>
       <td    bgcolor="#cccccc" width="auto"><strong><center>Grade</center></strong></td>
    </tr>
    <?php 
 ...
 if($exam!='test'){
    ...
    <tr> 
      ...
      <input name="dep" hidden value="<?php echo $tb;?>"> 
      <input name="tb" hidden value="<?php echo $tb2;?>">

       <td style="font-size:13px" ><strong><?php  echo $roll ; ?></strong></td> 
      <td style="font-size:12px" >&nbsp;&nbsp; <?php  echo $name ; ?> &nbsp;</td>
      <td  style="font-size:12px" >&nbsp;<?php  echo $department1; ?> </td>
         <td align="center" width=" " style="font-size:14px" ><strong><?php echo $dbsub_m; ?></strong></td>
         <td align="center"  width=" " style="font-size:14px" ><strong><?php echo check_grade($dbsub_m); ?><strong></td>
