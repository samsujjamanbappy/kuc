    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Update Student Results  </strong>
                        </h4>

                        <center> <form action="update_allstudent_result2.php" method="post">
     ...
     <tr>
       <td height="40"><strong>&nbsp;Select Batch : </strong></td><td>  
          <?php $te_id=$_SESSION['te_id']; $result3 = mysql_query("SELECT batch FROM section_teacher where teacher_id=$te_id order by batch desc");?>
