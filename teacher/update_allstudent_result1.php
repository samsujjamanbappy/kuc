            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Update <?php echo $exam1;?> Result Of Batch: <?php echo $batch; echo ' ('.$department.$paper.')';?></strong>
                        </h4>

          <a href="update_allstudent_result.php"><button type="button" class="btn btn-xs btn-default">Back</button></a><br /><br />
  <center>
...
<form action="submit_marks_all.php" method="post">
    ...
    <input name="col" hidden value="<?php echo $col; ?>"> 
      ...
      <td  style="font-size:12px" >&nbsp;<?php  echo $department1; ?> </td>
         <td  width=" " style="font-size:12px" ><input placeholder="Insert Marks here" value="<?php  echo $dbsub_m ; ?>" name="marks[]" type="text" /></td>
