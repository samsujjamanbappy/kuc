    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
  	        ...
  	        <center> <form action="view_allstudent_result.php" method="post">
                             <table width="450"  class=" table-striped table-bordered table-hover">
                              ...
                              <OPTION autofocus VALUE=>Select one</OPTION><OPTION VALUE='1st_p'>Frist Paper</OPTION><OPTION VALUE='2nd_p'>Second Paper</OPTION></OPTION></SELECT></td></tr>
