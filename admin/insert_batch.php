            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Insert Batch for Student</strong>
                        </h4>

                        <br /><br />


<form  action="submit_batch.php" method="post"> 
<table width="600px" class=" table-striped table-bordered table-hover" >
  <tr>
    <td width="110" height="50"><strong>&nbsp;&nbsp;Insert Batch: </strong></td>
    <td width="334">&nbsp;&nbsp;<input required name="batch" autofocus type="text" placeholder="Example: 2015 " size="50" /> </td>
  </tr>
