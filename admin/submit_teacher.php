            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Successfully inserted "<?php echo $_POST['fullname'] ?>" as a Teacher of <?php echo $_POST['department']; ?> department. </strong>
                        </h4>
...
$type = 'teacher'; 
           ...
           mysql_query("INSERT INTO login(id,name,full_name,password,phone,email,type,department) VALUES('','$username','$fullname','$password','$phone','$email','$type','$department')");
...
<br /><br />
<br /> <a  class="btn btn-primary" href="insert_teacher.php"> >> Insert another teacher </a>
