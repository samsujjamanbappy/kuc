                    ...
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  <?php echo $fname; ?></strong>
                      ...
                      $admin= $_SESSION['admin'];
                         $result3 = mysql_query("SELECT * FROM login where name='$admin'");
...
<tr> <td height="52"> Email : </td><td><strong><h4 style="font-size:14px; font-weight:bold;"><?php echo $email; ?></h4></strong></td></tr>
