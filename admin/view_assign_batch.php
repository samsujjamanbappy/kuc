            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> All Assign Batch For Teacher</strong>
                        </h4>
<a class="btn btn-default" href="assign_batch.php" > <strong> Assign Batch </strong></a>

                        <br /> 
                           <table align="center" width="500px" class=" table-striped table-bordered table-hover">
                                 <tr style="font-size:18px" ><td  bgcolor="#FF9900" height="60"><center><b>Teacher Name</b></center></td><td bgcolor="#FF9900" height="60" ><center><b>Department</b></center></td><td bgcolor="#FF9900"><center>
                                  <strong>Batch</strong> </center></td> <td bgcolor="#FF9900">&nbsp;</td> </tr>
                            <?php $result = mysql_query("SELECT * FROM section_teacher order by batch desc");
                              ...
                              while($row = mysql_fetch_array($result))
                                 {
                                  ...
                                  $result2 = mysql_query("SELECT * FROM login where id='$t_id'");
                              ...
                              while($row = mysql_fetch_array($result2))
                                ...
                                echo '<tr style="  text-align:left; font-weight:bolder;"><td height="40px" style="">&nbsp;'.$full_name.'</td><td height="40px" style="">&nbsp;'.$department.'</td><td align="center">&nbsp;'.$batch.'</td><td align="center">&nbsp;<a href="delete_assign_batch.php?sdi='.$t_id.'&& batch='.$batch.'"><input  class="btn btn-xs btn-danger" type="button" value="Delete"></a></td></tr>';} }?>
                                </table>
       ...
       <!-- /#page-wrapper -->
        ...
        <br /><br />
<p align="center" style="color:white; font-size:12.5px;">Developed by <a href="#"> <strong> Master Minds</strong></a></p><br />
    </div>
    <!-- /#wrapper -->
