            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Successfully Updated Information of " <?php echo $_POST['fname']; ?>". </strong>
                        </h4>
...
$department =$_POST['department'];     
   ...
   mysql_query("update login SET  password='$password', name='$name', full_name='$f_name', phone='$phone',email='$email' ,department='$department' WHERE id='$id'");

          
?><br /><br /><br /> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="allteacher.php"> <input type="button"  class="btn btn-primary" value="<< Back to all Teacher"/> </a>
<br /><br /><br /><br /><br /><br />
                    </div>
                </div>
                <!-- /.row -->
