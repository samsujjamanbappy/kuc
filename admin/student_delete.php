...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Comfirm Student Delete</strong>
                        </h4>
  ...
  <?php       $id=$_REQUEST['ids'];
  ?>
     <center> <h1 style="font-family:'Comic Sans MS', cursive; font-size:24px;"><strong>Are you sure to Delete  all information of <br /> <br />Roll Number </strong><strong>"<?php echo $id;?>"</strong>?</h1>
    <table width="200" height="63"><tr>
    <td width="58">&nbsp;&nbsp;  &nbsp;&nbsp;</td><td width="48"><a href="submit_student_delete_by_id.php?ids=<?php echo $id;?>"><strong>
       <input  style="font-size:21px"  type="button" class="btn btn-danger" value="Yes" />
    </strong></a></td>
    <td width="20">&nbsp;&nbsp; </td><td width="62">&nbsp;</td><td width="50"><a href="view_allstudent.php"><strong>
