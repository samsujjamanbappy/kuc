            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  All Student Result</strong>
                        </h4>

                        <br /><br />

<center> <form action="check_result_allstudent.php" method="post">
     <table width="450"  class="table-striped table-bordered table-hover">
     
         
     <tr><td width="120" height="46"><strong>&nbsp;Select Exam : </strong></td><td width="">&nbsp;
 <SELECT required  NAME='examtype'>  <OPTION VALUE=>Select one</OPTION><OPTION VALUE='1st'>Frist Semester Exam</OPTION><OPTION VALUE='2nd'>Second Semester Exam</OPTION><OPTION VALUE='3rd'>Year Change Exam</OPTION><OPTION VALUE='pre-test'>Pre-Test Exam</OPTION><OPTION VALUE='test'>Test Exam</OPTION></SELECT></td></tr>
   
      
     <tr><td width="180" height="46"><strong>&nbsp;Select Group : </strong></td><td width="">&nbsp;<select required name="group"><option value=""> Choose </option><option value="Science">Science</option><option value="Business Studies">Business Studies</option><option value="Humanities">Humanities</option></select></td></tr>
   
     <tr>
       <td height="38"><strong>&nbsp;Select Batch : </strong></td><td>  &nbsp;   <?php       include('connection.php'); $result3 = mysql_query("SELECT batch FROM batch order by batch desc");?>
     ...
     ?> </OPTION></SELECT></td></tr>
    <tr><td>&nbsp;</td><td height="45">&nbsp;<input class="btn btn-sm btn-success" type="submit" value="Submit" ></td></tr>
     </table> </form></center> 
