...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Insert Result</strong>
                        </h4>
 ...
 <SELECT required  NAME='examtype'>
     ...
     <tr>
       <td height="40"><strong>&nbsp;Select Batch : </strong></td><td>     <?php $result3 = mysql_query("SELECT batch FROM batch  order by batch desc");?>
     ...
     ?> </OPTION></SELECT></td></tr>
<tr height="40"><td>&nbsp;<strong>Select Group: </strong></td><td> &nbsp;<Select name="group" required><option>Select one ...</option><option value="Science">Science</option><option value="Business studies">Business studies</option><option value="Humanity">Humanity</option></Select></td></tr>
