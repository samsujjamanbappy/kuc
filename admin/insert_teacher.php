            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong>  Insert Teacher</strong>
                        </h4>
...
<tr><td width="160" height="47"> Department:</td><td width="482"> <select required name="department" >
                                            ...
                                            <option value="Production Management & Supply">Production Management & Supply</option>
                                            <option value="Sachibik bidda">Sachibik bidda</option>
                                            <option value="Economices">Economices</option>
                                            <option value="Logical Science">Logical Science</option>
                                            <option value="Civics">Civics</option>
                                            <option value="History of Islam">History of Islam</option>
                                            <option value="Psychology">Psychology</option>
                                            <option value="Islamic studies">Islamic studies</option>

                                            </select></td></tr>

<tr><td height="44">Full name:</td><td><input name="fullname" type="text" placeholder="Insert Full Name" size="50"></td></tr>

<tr> <td height="52"> Username : </td><td><input  required name="username" type="text"  placeholder="Insert Username" size="50"></td></tr>

<tr> <td height="49"> Password: </td><td><input name="password" type="text" required placeholder="Insert  password"  size="50"></td></tr>

<tr><td height="49"> Phone number: </td><td><input name="phone" type="text" placeholder="Insert Phone number" size="50"></td></tr>

<tr><td height="49"> Email Address: </td><td><input name="email" type="text" placeholder="Insert Email Address" size="50"></td></tr>
