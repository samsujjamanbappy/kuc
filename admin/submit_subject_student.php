...
$sub7 =$_POST['sub7'];  
    ...
    mysql_query("INSERT INTO 1st_semester(roll, sub1 ,sub2, sub3, sub4,sub5,sub6,sub7) VALUES('$roll','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$sub7')");
    mysql_query("INSERT INTO 2nd_semester(roll, sub1 ,sub2, sub3, sub4,sub5,sub6,sub7) VALUES('$roll','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$sub7')");
    mysql_query("INSERT INTO year_final(roll, sub1 ,sub2, sub3, sub4,sub5,sub6,sub7) VALUES('$roll','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$sub7')");
    
    mysql_query("INSERT INTO pre_test(roll, sub1 ,sub2, sub3, sub4,sub5,sub6,sub7) VALUES('$roll','$sub1','$sub2','$sub3','$sub4','$sub5','$sub6','$sub7')");
    mysql_query("INSERT INTO test_exam(roll, sub1 ,sub2, sub3, sub4,sub5,sub6,sub7,sub8, sub9, sub10,sub11,sub12,sub13) VALUES('$roll','$sub1','$sub1','$sub2','$sub2','$sub3','$sub4','$sub4','$sub5','$sub5','$sub6','$sub6','$sub7','$sub7')");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header alert alert-success">
                     <i class="fa fa-fw fa-edit"></i>  <strong> Congratulation. Student Successfully Inserted !!!</strong>
                        </h4><br /><br /><br />
</h1><br /> <a  class="btn btn-primary" href="insert_student.php"> >> Add another student </a></center>
