            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Successfully Updated Info of "<?php echo $_POST['roll']; ?>". </strong>
                        </h4>
...
$cgpa = $_POST['cgpa']; 
   ...
   mysql_query("update student_info SET  password='$password', name='$name', father_name='$fname', mother_name='$mname', gender='$gender', phone='$phone',ssc_cgpa='$cgpa' ,dob='$dob', address='$address', batch='$batch' WHERE roll='$roll'");

          
?><br /><br /><br /> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="view_allstudent.php"> <input type="button"  class="btn btn-primary" value="<< Back to all student"/> </a>
<br /><br /><br /><br /><br /><br />
                    </div>
                </div>
                <!-- /.row -->
