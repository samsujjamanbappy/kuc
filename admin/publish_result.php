            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Publishing Result for Student</strong>
                        </h4>

                       
<a class="btn btn-sm btn-primary" href="insert_result_publish.php"> <strong>Insert New Examination </strong></a>
                        <br /> <br />

       
<table   class="table table-striped table-bordered table-hover">
    <tr>
    <td width="15%" height="50px" bgcolor="#CCCCCC"><strong>Batch</strong></td>
    <td width="28%" height="50px" bgcolor="#CCCCCC"><strong>Name of Examination</strong></td>

     <td width="15%" bgcolor="#CCCCCC"><strong>Result Publish  </strong></td>
        <td width="35%" bgcolor="#CCCCCC"> <strong>Not-publish Message</strong> </td>
        <td width="10%" bgcolor="#CCCCCC">&nbsp;</td>
     </tr>
<?php
            include("connection.php");
            $result= mysql_query("SELECT * FROM result_publish order by batch desc");
...
?>
  <tr>
    <td  height="" >&nbsp;&nbsp;<strong><?php  echo $batch; ?></strong></td>
   <td  height="" >&nbsp;&nbsp;<strong><?php  echo $exam; ?></strong></td>
    <td><strong> <?php  echo $status; ?> </strong>&nbsp;</td>
    
     <td > <?php  echo $message; ?> </td>
     <td > &nbsp;<a  href="resultpublishedit.php?ids=<?php echo $id;?>"><input  class="btn btn-xs btn-primary" type="button" style=" font-size:12px; font-weight:bold;" value=" Edit " /></a>&nbsp;&nbsp;
    &nbsp; </td>
    </tr>
