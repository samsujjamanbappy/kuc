            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-edit"></i>  <strong> Showing Student Of Batch : <?php echo $batch;?> </strong>
                        </h4>
 <?php

     
  $result4= mysql_query("SELECT * FROM student_info WHERE batch='$batch' order by roll asc");
...
?>
    <tr>   <td height="28" style="font-size:12px" >&nbsp;&nbsp;
        <strong>
        <?php  echo $roll ; ?>
        </strong> &nbsp;</td> 
      <td style="font-size:12px" >&nbsp;&nbsp; <?php  echo $name ; ?> &nbsp;</td>
      <td  style="font-size:12px" >&nbsp;<?php  echo $department; ?> </td>
         <td  style="font-size:12px" width="25%" > &nbsp;&nbsp;&nbsp;<a href="student_details.php?ids=<?php echo $roll; ?>"><input class="btn btn-xs btn-success" type="submit" value="Details" /></a>&nbsp; <?php echo "<a href=\"edit_student_details.php?ids=$roll\">"?><input class="btn btn-xs btn-primary" type="submit" value="Edit" /></a>
         &nbsp;&nbsp;&nbsp;<a href="student_delete.php?ids=<?php echo $roll; ?>"><input class="btn btn-xs btn-danger" type="submit" value="Delete" /></a></td>
