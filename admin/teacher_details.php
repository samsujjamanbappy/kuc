            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                     ...
                     <i class="fa fa-fw fa-desktop"></i>  <strong>  Details</strong>
                        </h4>

                        <a   class="btn btn-sm btn-default"   href="javascript:history.go(-1)" title="Return to previous page"><< Back to previous page</a><br />
                        <?php 
...
<tr><td width="190px" height="49"> Full Name: </td><td><strong><h4 style="font-size:14px"><?php echo $f_name; ?></h4></strong></td></tr>

<tr><td height="49"> Username: </td><td><strong><h4 style="font-size:14px"><?php echo $name; ?></h4></strong></td></tr>

<tr> <td height="49"> Password: </td><td><strong><h4 style="font-size:14px"><?php echo $password; ?></h4></strong></td></tr>

<tr> <td height="52"> Department: </td><td><strong><h4 style="font-size:14px"><?php echo $department; ?></h4></strong></td></tr>

<tr><td height="46">Phone: </td><td><strong><h4 style="font-size:14px"><?php echo $phone; ?></h4></strong></td></tr>
 
<tr><td height="44">Email:</td><td><strong><h4 style="font-size:14px"><?php echo $email; ?></h4></strong></td></tr></tr>
